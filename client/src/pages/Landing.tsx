      ...
      <main className="container mx-auto px-6">
        ...
        <div className="py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="group hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border-0 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardTitle className="text-gray-900 dark:text-white">AI-Powered Search</CardTitle>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border-0 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardTitle className="text-gray-900 dark:text-white">SLA Management</CardTitle>
                <CardDescription className="text-gray-600 dark:text-slate-400">
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border-0 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardTitle className="text-gray-900 dark:text-white">System Integration</CardTitle>
                <CardDescription className="text-gray-600 dark:text-slate-400">
